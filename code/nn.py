...
layer_sizes = [ (1,), (5,), (10,), (100,), (1000,), (1,1), (5,5), (10,10), (100,100), (1000,1000), (5, 100, 100, 5) ]
...
def find_best_architecture(data, Classify_or_regress):
  ...
  for layer_size in layer_sizes:
    for alpha_val in alphas:
      if (Classify_or_regress):
        ...
        validation_score = get_testing_error_classifier(data, nn_predictor)
  ...
  if(Classify_or_regress):
    return opt_layer_size, opt_alpha, max_accuracy
  else:
    return opt_layer_size, opt_alpha, max_score
...
def calculate_score_nn_regressor(data, score_predictor):
  x_training, y_training = data[0], data[1]
  x_validate, y_validate = data[2], data[3]
  x_testing, y_testing = data[4], data[5]
...
if __name__ == '__main__':
  ...
  best_architecture = find_best_architecture(data_win_lose, False)
  ...
  # score_predictor = neural_network.MLPRegressor( solver = 'lbfgs', alpha = 0.6, hidden_layer_sizes = (20,))
  # score_predictor.fit(data_spreads[0], data_spreads[1])
  # print calculate_score_nn_regressor(data_spreads, score_predictor)
